...
<nav>
  <div class="logo">
    ...
    <a href="../User/index-user.php"><img src="../logo.png" alt="Ticketing System Logo" style="width:170px; height:auto; margin-right:20px;"></a>
  ...
  <ul>
    ...
    <li class="nav-item">
      <a class="nav-link" href="../User/index-user.php">Dashboard</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="../User/MyTickets.php">My Tickets</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="../User/CreateTicketUser.php">Create ticket</a>
    </li>
